...
static void button_send_state(uint8_t state);
...
/* Service */
static const uint16_t GATTS_SERVICE_BUTTON      = 0xA000;
static const uint16_t GATTS_CHAR_UUID_BUTTON    = 0xA001;
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
{
    ...
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&primary_service_uuid, ESP_GATT_PERM_READ,
      sizeof(uint16_t), sizeof(GATTS_SERVICE_BUTTON), (uint8_t *)&GATTS_SERVICE_BUTTON}},
...
//      CHAR_DECLARATION_SIZE, CHAR_DECLARATION_SIZE, (uint8_t *)&char_prop_read_write_notify}},
    ...
    [IDX_CHAR_VAL_A] =
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_BUTTON, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
...
static void button_send_state(uint8_t state)
{
  ...
  {
    esp_ble_gatts_send_indicate(gatts_if_global, conn_id_global, heart_rate_handle_table[IDX_CHAR_VAL_A],
                                sizeof(state), (uint8_t*)&state, true);
  }
}
